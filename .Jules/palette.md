...
## 2025-05-15 - Top Variable Width Highlights
**Learning:** In tools like `top`, applying inverse video to variable-width summary lines (like Mem or CPU usage) creates jagged, broken highlighting edges across terminal resizes and data updates.
**Action:** Apply inverse video styling only to fixed-width column headers, leaving variable-width summary lines unstyled.
